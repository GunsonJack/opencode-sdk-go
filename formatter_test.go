...
func TestFormatterGetUsesCorrectMethodAndPath(t *testing.T) {
	...
	_, err := client.Formatter.Status(context.Background(), opencode.FormatterStatusParams{
